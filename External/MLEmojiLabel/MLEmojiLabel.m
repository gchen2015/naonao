...
const CGFloat kEmojiWidthRatioWithLineHeight = 1.15;   //表情和字体高度的比例
...
- (void)commonInit {
    ...
    UIColor *commonLinkColor = GOLDEN_YELLOW;
    
    //点击时候的背景色
    [mutableActiveLinkAttributes setValue:(__bridge id)[[UIColor colorWithWhite:0.851 alpha:1.000] CGColor] forKey:(NSString *)kTTTBackgroundFillColorAttributeName];
