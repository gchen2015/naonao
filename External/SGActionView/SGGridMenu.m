...
- (void)layoutSubviews
{
    ...
    self.imageView.layer.cornerRadius = 10;//设置那个圆角的有多圆
...
- (void)setStyle:(SGActionViewStyle)style{
    ...
    self.backgroundColor = BACKGROUND_GARY_COLOR;
...
- (void)layoutContentScrollView
{
    ...
    CGSize itemSize = CGSizeMake((self.bounds.size.width - margin.left - margin.right) / 4, 90*mx);
