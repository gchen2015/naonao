    ...
    if (self) {
        ...
        for (int i = 0; i<Lines; i++)
        {
            for (int x = 0; x<NumPerLine; x++)
            {
                ...
                if (i*7+x+1 ==21) {
                    [expressionButton setBackgroundImage:[UIImage imageNamed:@"MLEmoji_Expression.bundle/DeleteEmoticonBtn_ios7@2x.png"]
                ...
                {
                    NSString *imageStr = [NSString stringWithFormat:@"MLEmoji_Expression.bundle/Expression_%ld@2x.png", index*20+i*7+x+1];
...
- (void)faceClick:(UIButton *)button{
    ...
    else
    {
        ...
        NSString *plistStr = [[NSBundle mainBundle]pathForResource:@"MLEmoji_ExpressionImage" ofType:@"plist"];
