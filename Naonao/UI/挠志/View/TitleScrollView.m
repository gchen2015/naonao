...
- (instancetype)initWithTitleArray:(NSArray *)titleArray itemWidth:(CGFloat)itemWidth{
    if (self = [super init]) {
        ...
        for (NSInteger i = 0; i < titleArray.count; i ++) {
            ...
            titleLabel.highlightedTextColor = PINK_COLOR;
        ...
        _lineView.backgroundColor = PINK_COLOR;
        ...
        //线条
        UIView *lineV = [[UIView alloc] initWithFrame:CGRectMake(0, 43.5, SCREEN_WIDTH, 0.5)];
        lineV.backgroundColor = STROKE_GARY_COLOR;
        [_titleScrollView addSubview:lineV];
    }
    return self;
}
