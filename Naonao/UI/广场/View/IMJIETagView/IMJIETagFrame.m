...
- (void)setTagsArray:(NSArray *)tagsArray
{
    ...
    for (NSInteger i=0; i<tagsArray.count; i++) {
        ...
        btnW = [self sizeWithText:tagsArray[i] font:[UIFont boldSystemFontOfSize:13.0]].width + _tagsMinPadding * 2;
        
        if (i < tagsArray.count-1) {
            nextWidth = [self sizeWithText:tagsArray[i+1] font:[UIFont boldSystemFontOfSize:13.0]].width + _tagsMinPadding * 2;
        }
    ...
    for (NSInteger i=0; i<lastIndexs.count; i++) {
        ...
        for (NSInteger j=0; j<newArr.count; j++) {
            ...
            tagW = [self sizeWithText:newArr[j] font:[UIFont boldSystemFontOfSize:13.0]].width + _tagsMinPadding * 2 + averageW;
